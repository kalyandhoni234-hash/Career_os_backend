...
def logged_in_client(client):
    client.post("/api/auth/signup", json={"email": "reviewuser@example.com", "password": "securepass123"})
    client.post("/api/auth/login", json={"email": "reviewuser@example.com", "password": "securepass123"})
    return client
...
def test_review_success(mock_generate, logged_in_client):
    ...
    logged_in_client.post("/api/resume", json={"full_name": "Test User", "summary": "A summary"})
    response = logged_in_client.post("/api/resume/review")
