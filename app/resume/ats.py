...
SKILL_VOCAB = {
    ...
    "node", "node.js", "nodejs", "deno", "bun",
    "java", "kotlin", "scala", "groovy", "go", "golang", "rust",
    "c++", "c", "c#", "csharp", ".net", "dotnet", "asp.net",
    "php", "laravel", "symfony", "ruby", "rails", "elixir", "phoenix",
    ...
    "aws", "gcp", "azure", "cloud", "lambda", "ec2", "s3", "cloudflare",
    "git", "github", "gitlab", "bitbucket", "ci/cd", "jenkins",
    "rest", "restful", "api", "apis", "graphql", "grpc", "websocket",
    "oauth", "jwt", "saml", "openid", "sso",
    "html", "css", "sass", "scss", "tailwind", "bootstrap", "material-ui",
    "redux", "zustand", "pinia", "vuex", "mobx", "recoil",
    "sqlalchemy", "prisma", "typeorm", "drizzle", "knex",
    "orm", "odm", "sequelize", "mongoose",
    "microservices", "soa", "event-driven", "cqrs", "event sourcing",
    "kafka", "rabbitmq", "nats", "pulsar", "pub/sub",
    "linux", "unix", "bash", "zsh", "powershell", "shell scripting",
    "testing", "pytest", "jest", "mocha", "chai", "cypress", "playwright",
    ...
    "machine learning", "ml", "deep learning", "ai", "llm", "nlp",
    "tensorflow", "pytorch", "keras", "scikit-learn", "pandas",
    "numpy", "matplotlib", "seaborn", "jupyter", "data science",
    "docker compose", "helm", "istio", "linkerd", "envoy",
    "prometheus", "grafana", "datadog", "new relic", "sentry",
    "openapi", "swagger", "postman", "insomnia",
    "webpack", "vite", "esbuild", "rollup", "turbo", "nx",
    "storybook", "chromatic", "figma", "sketch", "adobe xd",
...
SKILL_CATEGORIES = {
    "languages": {"python", "javascript", "typescript", "java", "kotlin", "scala", "go", "golang", "rust", "c++", "c", "c#", "csharp", "php", "ruby", "swift", "dart", "elixir", "groovy"},
    "frontend": {"react", "next.js", "nextjs", "vue", "vue.js", "angular", "svelte", "html", "css", "sass", "scss", "tailwind", "bootstrap", "redux", "zustand", "webpack", "vite"},
    "backend": {"flask", "django", "fastapi", "node", "node.js", "nodejs", "express", "laravel", "rails", "asp.net", "spring", "graphql", "grpc", "rest", "restful"},
    "databases": {"sql", "postgresql", "mysql", "mongodb", "redis", "elasticsearch", "cassandra", "dynamodb", "firebase", "supabase"},
    "devops": {"docker", "kubernetes", "k8s", "terraform", "ansible", "aws", "gcp", "azure", "ci/cd", "jenkins", "linux", "bash"},
    "ai": {"machine learning", "ml", "deep learning", "ai", "nlp", "llm", "tensorflow", "pytorch", "pandas", "numpy", "data science"},
    "testing": {"testing", "pytest", "jest", "cypress", "playwright", "unit testing", "tdd"},
}

ACTION_VERBS = {
    "achieved", "accelerated", "architected", "automated", "built", "championed",
    "consolidated", "created", "cut", "decreased", "delivered", "deployed",
    "designed", "developed", "doubled", "drove", "eliminated", "engineered",
    "established", "exceeded", "expanded", "generated", "grew", "implemented",
    "improved", "increased", "initiated", "innovated", "integrated", "introduced",
    "launched", "led", "managed", "mentored", "migrated", "negotiated",
    "optimized", "orchestrated", "overhauled", "pioneered", "proposed",
    "reduced", "reengineered", "reorganized", "resolved", "restructured",
    "revamped", "scaled", "shipped", "simplified", "slashed", "spearheaded",
    "standardized", "streamlined", "strengthened", "transformed", "upgraded",
}

WEAK_VERBS = {
    "was", "were", "been", "being", "have", "has", "had", "do", "does", "did",
    "made", "got", "get", "got", "worked", "worked on", "helped", "assisted",
    "participated", "involved", "responsible for", "tasked with", "handled",
    "did", "done", "made", "fixed",
}
...
def score_resume(resume, job_description: str) -> dict:
    ...
    for cat, terms in SKILL_CATEGORIES.items():
        ...
        if cat_in_jd:
            ...
            category_scores[cat] = round((len(cat_matched) / len(cat_in_jd)) * 100) if cat_in_jd else 100
    ...
    weak_verbs_found = {v for v in WEAK_VERBS if re.search(rf"\b{re.escape(v)}\b", exp_text)}
    action_verb_score = round((len(action_verbs_found) / max(len(action_verbs_found) + len(weak_verbs_found), 1)) * 100)

    # Skills density
    all_words = re.findall(r"[a-zA-Z][a-zA-Z0-9+.#/\-]{1,}", body)
    skill_count = len([w for w in all_words if w in SKILL_VOCAB])
    skills_density = round((skill_count / max(len(all_words), 1)) * 100, 1) if all_words else 0
