...
def upgrade():
    ...
    op.add_column('jobs', sa.Column('next_action', sa.String(length=255), nullable=True))
    op.add_column('jobs', sa.Column('resume_version', sa.String(length=50), nullable=True))
